...
namespace WebSocket.Workers
{
    public class BinanceFuturesUsdTradeWorker : BackgroundService
    {
        ...
        public BinanceFuturesUsdTradeWorker(BinanceZeroMQProperties options, SocketServer server)
        {
            _options = options;
            this._server = server;
        ...
        public override Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            _subBinanceTrade.Connect(WebSocketHelper.GetZeroMQAddress(_options.PublisherIPAddress, _options.BinanceFuturesUsdTradePort));
