...
{
    public class BinanceOrderbookWorker : BackgroundService
    {
        ...
        public BinanceOrderbookWorker(BinanceZeroMQProperties options, SocketServer server)
        {
            _options = options;
            this._server = server;
        ...
        public override Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            _subBinanceOrderbook.Connect(WebSocketHelper.GetZeroMQAddress(_options.PublisherIPAddress, _options.BinanceOrderbookPort));
